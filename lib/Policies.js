...
class Policies {
  // TODO(#28): remove referneces of env policies
  /*
      ...
      if (result[key] !== undefined) {
        throw Error(
          "Attempting to overwrite a local policy result: " +
            `this is a newly created object, it shouldn't have ${key} yet. ` +
